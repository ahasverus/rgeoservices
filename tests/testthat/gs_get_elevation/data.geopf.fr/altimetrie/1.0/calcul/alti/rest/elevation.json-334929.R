structure(list(method = "GET", url = "https://data.geopf.fr/altimetrie/1.0/calcul/alti/rest/elevation.json?lon=3.5960877&lat=44.3269017&resource=ign_rge_alti_wld&delimiter=%7C&indent=false&measures=false&zonly=false", 
    status_code = 200L, headers = structure(list(date = "Sun, 09 Feb 2025 15:02:30 GMT", 
        ...
        `x-iplb-request-id` = "5D184490:D6FE_91EFC1E7:01BB_67A8C386_575BCBD3:2AAB", 
        `x-iplb-instance` = "61218"), class = "httr2_headers"), 
    body = charToRaw("{\"elevations\": [{\"lon\": 3.5960877, \"lat\": 44.3269017, \"z\": 547.42, \"acc\": \"Variable suivant la source de mesure\"}]}"), 
