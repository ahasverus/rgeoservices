...
Conduct](https://github.com/ahasverus/rgeoservices/blob/main/CODE_OF_CONDUCT.md).
...
[Issues](https://github.com/ahasverus/rgeoservices/issues) that might
...
- Open a new
  [Issue](https://github.com/ahasverus/rgeoservices/issues/new).
- Use the template
  [other_issue.md](https://github.com/ahasverus/rgeoservices/blob/main/.github/ISSUE_TEMPLATE/other_issue.md).
...
- To see if other users have experienced (and potentially already
  ...
  tracker](https://github.com/ahasverus/rgeoservices/issues?q=label%3Abug).

### How do I submit a bug report?

We use [GitHub Issues](https://github.com/ahasverus/rgeoservices/issues)
to track bugs and errors. If you run into an issue with the project:

- Open a new
  [Issue](https://github.com/ahasverus/rgeoservices/issues/new).
- Use the template
  [bug_report.md](https://github.com/ahasverus/rgeoservices/blob/main/.github/ISSUE_TEMPLATE/bug_report.md).
...
- Perform a [search](https://github.com/ahasverus/rgeoservices/issues)
...
Issues](https://github.com/ahasverus/rgeoservices/issues).

- Open a new
  [Issue](https://github.com/ahasverus/rgeoservices/issues/new).
- Use the template
  [feature_request.md](https://github.com/ahasverus/rgeoservices/blob/main/.github/ISSUE_TEMPLATE/feature_request.md).
- Provide a clear and descriptive title for the issue to identify the
  suggestion.
- Provide a step-by-step description of the suggested enhancement in as
  many details as possible.
- Explain why this enhancement would be useful to most `rgeoservices`
  users.
...
7.  Submit a [Pull
    ...
    on the [original
    repo](https://github.com/ahasverus/rgeoservices/compare).
